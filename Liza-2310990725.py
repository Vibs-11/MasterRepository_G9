...
if __name__ == "__main__": 
    ...
    power_button = Button(gui, text=' ^ ', fg='black', bg='white', 
                command=powerpress, height=1, width=7)
    power_button.grid(row=6, column=1)

    log_button = Button(gui, text=' ln ', fg='black', bg='white', 
                command=calculate_log, height=1, width=7) 
    log_button.grid(row=6, column=2)

    sqrt_button = Button(gui, text=' √ ', fg='black', bg='white', 
                command=calculate_sqrt, height=1, width=7) 
