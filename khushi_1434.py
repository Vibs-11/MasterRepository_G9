...
lg = Button(root, text="log", padx=28, pady=10, relief=RAISED,bg="black",fg="white")
lg.bind("<Button-1>", sc)
...
ac = Button(root, text="C", padx=29, pady=10, relief=RAISED,bg="red",command=lambda:clear())
bksp = Button(root, text="Bksp", padx=19, pady=10, relief=RAISED,bg="red",command=lambda:bksps())               
mod = Button(root, text="mod", padx=19, pady=10, relief=RAISED,bg="black",fg="white",command=lambda:click("mod"))
...
seven = Button(root, text="7", padx=30, pady=10, relief=RAISED,bg="grey",command=lambda:click("7"))
eight = Button(root, text="8", padx=29, pady=10, relief=RAISED,bg="grey",command=lambda:click("8"))
nine =Button (root, text="9", padx=29, pady=10, relief=RAISED,bg="grey",command=lambda:click("9"))
...
four=Button (root, text="4", padx=30, pady=10, relief=RAISED,bg="grey",command=lambda:click("4"))
five =Button (root, text="5", padx=29, pady=10, relief=RAISED,bg="grey",command=lambda:click("5"))
six =Button (root, text="6", padx=29, pady=10, relief=RAISED,bg="grey",command=lambda:click("6"))
...
one = Button(root, text="1", padx=30, pady=10, relief =RAISED,bg="grey",command=lambda:click("1"))
two = Button(root, text="2", padx=29, pady=10, relief= RAISED,bg="grey",command=lambda:click("2"))
three = Button(root, text="3", padx=29, pady=10, relief=RAISED,bg="grey",command=lambda:click("3"))
...
zero = Button(root, text="0", padx=29, pady=10, relief=RAISED,bg="grey",command=lambda:click("0"))
equal=Button (root, text="=", padx=29, pady=10, relief=RAISED,bg="yellow",command=evaluate)
